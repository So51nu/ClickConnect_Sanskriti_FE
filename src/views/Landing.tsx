...
// Same filenames used in the PHP version.
// Upload both files inside: public/images/
...
// // //             {/* ADMIN LOGIN */}
// // //             <div style={{ marginLeft: "auto", paddingRight: "clamp(6px, .75vw, 12px)", flexShrink: 0 }}>
// // //               <a
// // //                 href="/admin"
// // //                 style={{
// // //                   display: "inline-flex",
...
// // //         {!isMobile && !isTablet && (
// // //           <div className="header-right" style={{ display: "flex", height: "100%", width: rightSectionWidth, flex: `0 0 ${rightSectionWidth}`, minWidth: 0 }}>
// // //             <div
...
// // //             >
// // //               📄
// // //               <div style={{ fontSize: "clamp(9px, .62vw, 10px)", lineHeight: 1.2, whiteSpace: "nowrap" }}>
// // //                 Download <br />
// // //                 <b>Price Sheet</b>
// // //               </div>
// // //             </div>
...
export default function LandingPage() {
  ...
  // Hero background video + logo state (same behavior as PHP version)
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      // Same as PHP version: image slider is only a fallback.
...
{/* 
                  We are an authorised marketing partner for this project. Provided content is for informational purposes only.
                  Prices mentioned are subject to change without prior notice and properties are subject to availability. 
                  You may receive calls, SMS or emails on the details registered with us. */}
